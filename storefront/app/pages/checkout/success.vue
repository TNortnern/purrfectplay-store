        ...
        <div class="bg-white rounded-3xl shadow-2xl border border-stone-100 overflow-hidden">
          ...
          <div class="p-8">
            ...
            <div class="bg-stone-50 rounded-2xl p-5 mb-6 text-center border border-stone-100">
              <p class="text-sm text-stone-500 uppercase tracking-wide mb-1">
                Order Number
              </p>
            ...
            <div
              v-if="session?.customer || session?.shipping"
              class="grid gap-4 mb-6"
            >
              <div
                v-if="session?.customer"
                class="flex items-start gap-4 p-4 bg-stone-50 rounded-xl"
              >
            ...
            <!-- Order Summary -->
            <div
              v-if="session?.lineItems?.length"
              class="border-t border-stone-200 pt-6 mb-6"
            >
              <h3 class="text-sm font-semibold text-stone-900 uppercase tracking-wide mb-4">
                Order Summary
              </h3>
              <div class="space-y-3">
                <div
            ...
            <div class="bg-gradient-to-r from-stone-50 to-teal-50 rounded-2xl p-5 mb-6">
              <h3 class="text-sm font-semibold text-stone-900 uppercase tracking-wide mb-3">
                What's Next?
              </h3>
              <div class="space-y-3">
                <div class="flex items-center gap-3">
            ...
            <p class="text-center text-sm text-stone-500 mt-6">
              Questions?
              <a
                href="mailto:support@catiohaven.com"
